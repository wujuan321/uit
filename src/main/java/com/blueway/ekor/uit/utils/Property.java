...
public class Property {
	...
	public static final String LOGIN_ADMIN_USERNAME = getProperty("login.username");
	public static final String LOGIN_ADMIN_PASSWORD = getProperty("login.password");
	...
	public static void getProperties() {
		LoggerUtils.info("try to get test properties from external file "
				+ PROPERTY_FILE);
