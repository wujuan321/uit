...
public class MyReporterListener extends MyReporterListenerAdapter {
	...
	protected void startHtml(PrintWriter out) {
		...
		out.println(".passedodd td {background-color: #CCEECC}");
		out.println(".passedeven td {background-color: #F4FBF4}");
		out.println(".skippedodd td {background-color: #CCC}");
		out.println(".skippedodd td {background-color: #DDD}");
		out.println(".failedodd td,.numi_attn {background-color: #F7A0A0}");
		out.println(".failedeven td,.stripe .numi_attn {background-color: #FBCFCF}");
